...
# load variables
jrrf_tde = readdlm("./scripts/Duffing/ensemble results torus/jrrf_tde.csv")
jrrf_GA = readdlm("./scripts/Duffing/ensemble results torus/jrrf_GA.csv")
jrrf_mdop = readdlm("./scripts/Duffing/ensemble results torus/jrrf_mdop.csv")
jrrf_pec = readdlm("./scripts/Duffing/ensemble results torus/jrrf_pec.csv")
mfnn_tde = readdlm("./scripts/Duffing/ensemble results torus/mfnn_tde.csv")
mfnn_GA = readdlm("./scripts/Duffing/ensemble results torus/mfnn_GA.csv")
mfnn_mdop = readdlm("./scripts/Duffing/ensemble results torus/mfnn_mdop.csv")
mfnn_pec = readdlm("./scripts/Duffing/ensemble results torus/mfnn_pec.csv")
L_tde = readdlm("./scripts/Duffing/ensemble results torus/L_tde.csv")
L_GA = readdlm("./scripts/Duffing/ensemble results torus/L_GA.csv")
L_mdop = readdlm("./scripts/Duffing/ensemble results torus/L_mdop.csv")
L_pec = readdlm("./scripts/Duffing/ensemble results torus/L_pec.csv")
DET_tde = readdlm("./scripts/Duffing/ensemble results torus/DET_tde.csv")
DET_GA = readdlm("./scripts/Duffing/ensemble results torus/DET_GA.csv")
DET_mdop = readdlm("./scripts/Duffing/ensemble results torus/DET_mdop.csv")
DET_pec = readdlm("./scripts/Duffing/ensemble results torus/DET_pec.csv")
DET_ref = readdlm("./scripts/Duffing/ensemble results torus/DET_ref.csv")
LAM_tde = readdlm("./scripts/Duffing/ensemble results torus/LAM_tde.csv")
LAM_GA = readdlm("./scripts/Duffing/ensemble results torus/LAM_GA.csv")
LAM_mdop = readdlm("./scripts/Duffing/ensemble results torus/LAM_mdop.csv")
LAM_pec = readdlm("./scripts/Duffing/ensemble results torus/LAM_pec.csv")
LAM_ref = readdlm("./scripts/Duffing/ensemble results torus/LAM_ref.csv")
RTE_tde = readdlm("./scripts/Duffing/ensemble results torus/RTE_tde.csv")
RTE_GA = readdlm("./scripts/Duffing/ensemble results torus/RTE_GA.csv")
RTE_mdop = readdlm("./scripts/Duffing/ensemble results torus/RTE_mdop.csv")
RTE_pec = readdlm("./scripts/Duffing/ensemble results torus/RTE_pec.csv")
RTE_ref = readdlm("./scripts/Duffing/ensemble results torus/RTE_ref.csv")
ENTR_tde = readdlm("./scripts/Duffing/ensemble results torus/ENTR_tde.csv")
ENTR_GA = readdlm("./scripts/Duffing/ensemble results torus/ENTR_GA.csv")
ENTR_mdop = readdlm("./scripts/Duffing/ensemble results torus/ENTR_mdop.csv")
ENTR_pec = readdlm("./scripts/Duffing/ensemble results torus/ENTR_pec.csv")
ENTR_ref = readdlm("./scripts/Duffing/ensemble results torus/ENTR_ref.csv")
dims_tde = readdlm("./scripts/Duffing/ensemble results torus/dim_tde.csv")
dims_GA = readdlm("./scripts/Duffing/ensemble results torus/dim_GA.csv")
dims_mdop = readdlm("./scripts/Duffing/ensemble results torus/dim_mdop.csv")
dims_pec = readdlm("./scripts/Duffing/ensemble results torus/dim_pec.csv")
TRANS_tde = readdlm("./scripts/Duffing/ensemble results torus/TRANS_tde.csv")
TRANS_GA = readdlm("./scripts/Duffing/ensemble results torus/TRANS_GA.csv")
TRANS_mdop = readdlm("./scripts/Duffing/ensemble results torus/TRANS_mdop.csv")
TRANS_pec = readdlm("./scripts/Duffing/ensemble results torus/TRANS_pec.csv")
TRANS_ref = readdlm("./scripts/Duffing/ensemble results torus/TRANS_ref.csv")
