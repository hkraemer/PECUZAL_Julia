...
writedlm("./scripts/Mackey Glass/ensemble results/TRANS_ref.csv", TRANS_ref)
writedlm("./scripts/Mackey Glass/ensemble results/TRANS_tde.csv", TRANS_tde)
writedlm("./scripts/Mackey Glass/ensemble results/TRANS_mdop.csv", TRANS_mdop)
writedlm("./scripts/Mackey Glass/ensemble results/TRANS_GA.csv", TRANS_GA)
writedlm("./scripts/Mackey Glass/ensemble results/TRANS_pec.csv", TRANS_pec)
