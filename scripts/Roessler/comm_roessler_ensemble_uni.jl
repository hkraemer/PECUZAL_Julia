...
writedlm("./scripts/Roessler/ensemble results uni/TRANS_ref.csv", TRANS_ref)
writedlm("./scripts/Roessler/ensemble results uni/TRANS_tde.csv", TRANS_tde)
writedlm("./scripts/Roessler/ensemble results uni/TRANS_mdop.csv", TRANS_mdop)
writedlm("./scripts/Roessler/ensemble results uni/TRANS_GA.csv", TRANS_GA)
writedlm("./scripts/Roessler/ensemble results uni/TRANS_pec.csv", TRANS_pec)
