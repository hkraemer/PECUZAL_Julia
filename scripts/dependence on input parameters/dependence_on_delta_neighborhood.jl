...
# writedlm("dependence_on_delta_neighborhood_Ks.csv",Ks)
# writedlm("dependence_on_delta_neighborhood_sizes.csv",sizes)
# writedlm("dependence_on_delta_neighborhood_Ls.csv",Ls)
# writedlm("dependence_on_delta_neighborhood_tau_vals.csv",τ_vals)
