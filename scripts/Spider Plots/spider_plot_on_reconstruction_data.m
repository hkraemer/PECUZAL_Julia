...
% plotting the results from scripts
% `analyze_duffing_ensemble_uni.jl`, `analyze_duffing_ensemble.jl`
% `analyze_roessler_ensemble_funnel_uni.jl`, `analyze_roessler_ensemble_funnel.jl`
