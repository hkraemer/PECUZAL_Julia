...
# load variables
jrrf_tde = readdlm("./scripts/Roessler/ensemble results/jrrf_tde.csv")
jrrf_GA = readdlm("./scripts/Roessler/ensemble results/jrrf_GA.csv")
jrrf_mdop = readdlm("./scripts/Roessler/ensemble results/jrrf_mdop.csv")
jrrf_pec = readdlm("./scripts/Roessler/ensemble results/jrrf_pec.csv")
mfnn_tde = readdlm("./scripts/Roessler/ensemble results/mfnn_tde.csv")
mfnn_GA = readdlm("./scripts/Roessler/ensemble results/mfnn_GA.csv")
mfnn_mdop = readdlm("./scripts/Roessler/ensemble results/mfnn_mdop.csv")
mfnn_pec = readdlm("./scripts/Roessler/ensemble results/mfnn_pec.csv")
L_tde = readdlm("./scripts/Roessler/ensemble results/L_tde.csv")
...
DET_pec = readdlm("./scripts/Roessler/ensemble results/DET_pec.csv")
DET_ref = readdlm("./scripts/Roessler/ensemble results/DET_ref.csv")
LAM_tde = readdlm("./scripts/Roessler/ensemble results/LAM_tde.csv")
LAM_GA = readdlm("./scripts/Roessler/ensemble results/LAM_GA.csv")
LAM_mdop = readdlm("./scripts/Roessler/ensemble results/LAM_mdop.csv")
LAM_pec = readdlm("./scripts/Roessler/ensemble results/LAM_pec.csv")
LAM_ref = readdlm("./scripts/Roessler/ensemble results/LAM_ref.csv")
RTE_tde = readdlm("./scripts/Roessler/ensemble results/RTE_tde.csv")
RTE_GA = readdlm("./scripts/Roessler/ensemble results/RTE_GA.csv")
RTE_mdop = readdlm("./scripts/Roessler/ensemble results/RTE_mdop.csv")
RTE_pec = readdlm("./scripts/Roessler/ensemble results/RTE_pec.csv")
RTE_ref = readdlm("./scripts/Roessler/ensemble results/RTE_ref.csv")
ENTR_tde = readdlm("./scripts/Roessler/ensemble results/ENTR_tde.csv")
ENTR_GA = readdlm("./scripts/Roessler/ensemble results/ENTR_GA.csv")
ENTR_mdop = readdlm("./scripts/Roessler/ensemble results/ENTR_mdop.csv")
ENTR_pec = readdlm("./scripts/Roessler/ensemble results/ENTR_pec.csv")
ENTR_ref = readdlm("./scripts/Roessler/ensemble results/ENTR_ref.csv")
dims_tde = readdlm("./scripts/Roessler/ensemble results/dim_tde.csv")
