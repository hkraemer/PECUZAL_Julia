...
# save results
writedlm("./ensemble results funnel/L_tde.csv", L_tde)
writedlm("./ensemble results funnel/L_mdop.csv", L_mdop)
writedlm("./ensemble results funnel/L_GA.csv", L_GA)
writedlm("./ensemble results funnel/L_pec.csv", L_pec)

writedlm("./ensemble results funnel/dim_tde.csv", dim_tde)
writedlm("./ensemble results funnel/dim_mdop.csv", dim_mdop)
writedlm("./ensemble results funnel/dim_GA.csv", dim_GA)
writedlm("./ensemble results funnel/dim_pec.csv", dim_pec)

writedlm("./ensemble results funnel/mfnn_tde.csv", mfnn_tde)
writedlm("./ensemble results funnel/mfnn_mdop.csv", mfnn_mdop)
writedlm("./ensemble results funnel/mfnn_GA.csv", mfnn_GA)
writedlm("./ensemble results funnel/mfnn_pec.csv", mfnn_pec)

writedlm("./ensemble results funnel/jrrf_tde.csv", jrrf_tde)
writedlm("./ensemble results funnel/jrrf_mdop.csv", jrrf_mdop)
writedlm("./ensemble results funnel/jrrf_GA.csv", jrrf_GA)
writedlm("./ensemble results funnel/jrrf_pec.csv", jrrf_pec)

writedlm("./ensemble results funnel/DET_ref.csv", DET_ref)
writedlm("./ensemble results funnel/DET_tde.csv", DET_tde)
writedlm("./ensemble results funnel/DET_mdop.csv", DET_mdop)
writedlm("./ensemble results funnel/DET_GA.csv", DET_GA)
writedlm("./ensemble results funnel/DET_pec.csv", DET_pec)

writedlm("./ensemble results funnel/ENTR_ref.csv", ENTR_ref)
writedlm("./ensemble results funnel/ENTR_tde.csv", ENTR_tde)
writedlm("./ensemble results funnel/ENTR_mdop.csv", ENTR_mdop)
writedlm("./ensemble results funnel/ENTR_GA.csv", ENTR_GA)
writedlm("./ensemble results funnel/ENTR_pec.csv", ENTR_pec)

writedlm("./ensemble results funnel/RTE_ref.csv", RTE_ref)
writedlm("./ensemble results funnel/RTE_tde.csv", RTE_tde)
writedlm("./ensemble results funnel/RTE_mdop.csv", RTE_mdop)
writedlm("./ensemble results funnel/RTE_GA.csv", RTE_GA)
writedlm("./ensemble results funnel/RTE_pec.csv", RTE_pec)

writedlm("./ensemble results funnel/LAM_ref.csv", LAM_ref)
writedlm("./ensemble results funnel/LAM_tde.csv", LAM_tde)
writedlm("./ensemble results funnel/LAM_mdop.csv", LAM_mdop)
writedlm("./ensemble results funnel/LAM_GA.csv", LAM_GA)
writedlm("./ensemble results funnel/LAM_pec.csv", LAM_pec)

writedlm("./ensemble results funnel/TRANS_ref.csv", TRANS_ref)
writedlm("./ensemble results funnel/TRANS_tde.csv", TRANS_tde)
writedlm("./ensemble results funnel/TRANS_mdop.csv", TRANS_mdop)
writedlm("./ensemble results funnel/TRANS_GA.csv", TRANS_GA)
writedlm("./ensemble results funnel/TRANS_pec.csv", TRANS_pec)
