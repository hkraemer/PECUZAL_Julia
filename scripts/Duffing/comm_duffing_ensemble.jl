...
# save results
writedlm("./scripts/Duffing/ensemble results/L_ref.csv", L_ref)
writedlm("./scripts/Duffing/ensemble results/L_tde.csv", L_tde)
writedlm("./scripts/Duffing/ensemble results/L_mdop.csv", L_mdop)
writedlm("./scripts/Duffing/ensemble results/L_GA.csv", L_GA)
writedlm("./scripts/Duffing/ensemble results/L_pec.csv", L_pec)

writedlm("./scripts/Duffing/ensemble results/dim_tde.csv", dim_tde)
writedlm("./scripts/Duffing/ensemble results/dim_mdop.csv", dim_mdop)
writedlm("./scripts/Duffing/ensemble results/dim_GA.csv", dim_GA)
writedlm("./scripts/Duffing/ensemble results/dim_pec.csv", dim_pec)

writedlm("./scripts/Duffing/ensemble results/mfnn_tde.csv", mfnn_tde)
writedlm("./scripts/Duffing/ensemble results/mfnn_mdop.csv", mfnn_mdop)
writedlm("./scripts/Duffing/ensemble results/mfnn_GA.csv", mfnn_GA)
writedlm("./scripts/Duffing/ensemble results/mfnn_pec.csv", mfnn_pec)

writedlm("./scripts/Duffing/ensemble results/jrrf_tde.csv", jrrf_tde)
writedlm("./scripts/Duffing/ensemble results/jrrf_mdop.csv", jrrf_mdop)
writedlm("./scripts/Duffing/ensemble results/jrrf_GA.csv", jrrf_GA)
writedlm("./scripts/Duffing/ensemble results/jrrf_pec.csv", jrrf_pec)

writedlm("./scripts/Duffing/ensemble results/DET_ref.csv", DET_ref)
writedlm("./scripts/Duffing/ensemble results/DET_tde.csv", DET_tde)
writedlm("./scripts/Duffing/ensemble results/DET_mdop.csv", DET_mdop)
writedlm("./scripts/Duffing/ensemble results/DET_GA.csv", DET_GA)
writedlm("./scripts/Duffing/ensemble results/DET_pec.csv", DET_pec)

writedlm("./scripts/Duffing/ensemble results/ENTR_ref.csv", ENTR_ref)
writedlm("./scripts/Duffing/ensemble results/ENTR_tde.csv", ENTR_tde)
writedlm("./scripts/Duffing/ensemble results/ENTR_mdop.csv", ENTR_mdop)
writedlm("./scripts/Duffing/ensemble results/ENTR_GA.csv", ENTR_GA)
writedlm("./scripts/Duffing/ensemble results/ENTR_pec.csv", ENTR_pec)

writedlm("./scripts/Duffing/ensemble results/RTE_ref.csv", RTE_ref)
writedlm("./scripts/Duffing/ensemble results/RTE_tde.csv", RTE_tde)
writedlm("./scripts/Duffing/ensemble results/RTE_mdop.csv", RTE_mdop)
writedlm("./scripts/Duffing/ensemble results/RTE_GA.csv", RTE_GA)
writedlm("./scripts/Duffing/ensemble results/RTE_pec.csv", RTE_pec)

writedlm("./scripts/Duffing/ensemble results/LAM_ref.csv", LAM_ref)
writedlm("./scripts/Duffing/ensemble results/LAM_tde.csv", LAM_tde)
writedlm("./scripts/Duffing/ensemble results/LAM_mdop.csv", LAM_mdop)
writedlm("./scripts/Duffing/ensemble results/LAM_GA.csv", LAM_GA)
writedlm("./scripts/Duffing/ensemble results/LAM_pec.csv", LAM_pec)

writedlm("./scripts/Duffing/ensemble results/TRANS_ref.csv", TRANS_ref)
writedlm("./scripts/Duffing/ensemble results/TRANS_tde.csv", TRANS_tde)
writedlm("./scripts/Duffing/ensemble results/TRANS_mdop.csv", TRANS_mdop)
writedlm("./scripts/Duffing/ensemble results/TRANS_GA.csv", TRANS_GA)
writedlm("./scripts/Duffing/ensemble results/TRANS_pec.csv", TRANS_pec)
