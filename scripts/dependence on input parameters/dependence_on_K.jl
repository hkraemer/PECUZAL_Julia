...
# writedlm("dependence_on_K_Ks.csv",Ks)
# writedlm("dependence_on_K_sizes.csv",sizes)
# writedlm("dependence_on_K_Ls.csv",Ls)
# writedlm("dependence_on_K_tau_vals.csv",τ_vals)
