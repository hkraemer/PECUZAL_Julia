...
# load variables
jrrf_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/jrrf_tde.csv")
jrrf_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/jrrf_GA.csv")
jrrf_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/jrrf_mdop.csv")
jrrf_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/jrrf_pec.csv")
mfnn_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/mfnn_tde.csv")
mfnn_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/mfnn_GA.csv")
mfnn_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/mfnn_mdop.csv")
mfnn_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/mfnn_pec.csv")
L_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/L_tde.csv")
L_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/L_GA.csv")
L_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/L_mdop.csv")
L_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/L_pec.csv")
DET_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/DET_tde.csv")
DET_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/DET_GA.csv")
DET_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/DET_mdop.csv")
DET_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/DET_pec.csv")
DET_ref = readdlm("./scripts/Roessler/ensemble results funnel uni/DET_ref.csv")
LAM_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/LAM_tde.csv")
LAM_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/LAM_GA.csv")
LAM_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/LAM_mdop.csv")
LAM_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/LAM_pec.csv")
LAM_ref = readdlm("./scripts/Roessler/ensemble results funnel uni/LAM_ref.csv")
RTE_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/RTE_tde.csv")
RTE_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/RTE_GA.csv")
RTE_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/RTE_mdop.csv")
RTE_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/RTE_pec.csv")
RTE_ref = readdlm("./scripts/Roessler/ensemble results funnel uni/RTE_ref.csv")
ENTR_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/ENTR_tde.csv")
ENTR_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/ENTR_GA.csv")
ENTR_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/ENTR_mdop.csv")
ENTR_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/ENTR_pec.csv")
ENTR_ref = readdlm("./scripts/Roessler/ensemble results funnel uni/ENTR_ref.csv")
dims_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/dim_tde.csv")
dims_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/dim_GA.csv")
dims_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/dim_mdop.csv")
dims_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/dim_pec.csv")
TRANS_tde = readdlm("./scripts/Roessler/ensemble results funnel uni/TRANS_tde.csv")
TRANS_GA = readdlm("./scripts/Roessler/ensemble results funnel uni/TRANS_GA.csv")
TRANS_mdop = readdlm("./scripts/Roessler/ensemble results funnel uni/TRANS_mdop.csv")
TRANS_pec = readdlm("./scripts/Roessler/ensemble results funnel uni/TRANS_pec.csv")
TRANS_ref = readdlm("./scripts/Roessler/ensemble results funnel uni/TRANS_ref.csv")
